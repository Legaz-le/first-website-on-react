...
const Header = () => {
  const [hassScrolled, setHasScrolled] = useState(false);
  ...
  return (
    <header
      className={clsx(
        ...
        hassScrolled && "py-2 bg-black-100 backdrop-blur-[8px]"
      )}
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        ...
        <div
          className={clsx(
            "w-full max-lg:fixed max-lg:top-0 max-lg:lef-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0",
              ...
              <ul className="flex max-lg:block max-lg:px-12">
                ...
                <li className="nav-logo">
                  <LinkScroll
                    ...
                    smooth
                    className={clsx(
                      "max-lg:hidden tranisiton-transform duration-500 cursor-pointer"
                    )}
                  >
                    <img
                      src="/public/images/xora.svg"
        ...
        <button
          className="lg:hidden z-2 size-10 boder-2 boder-s4/25
